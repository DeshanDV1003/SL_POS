...
public interface ISalesService
{
    ...
    Task<SaleReceiptDto> RefundSaleAsync(long companyId, long branchId, long? terminalId, long userId, long originalSaleId, RefundSaleRequest request, CancellationToken cancellationToken = default);
