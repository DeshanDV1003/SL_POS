        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRegistrationNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IsVatRegistered = table.Column<bool>(type: "bit", nullable: false),
                    VatRegisteredFromDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FiscalTransmissions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessTypeFlags = table.Column<int>(type: "int", nullable: false),
                    ServiceChargeRate = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<long>(type: "bigint", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FiscalTransmissions_SaleHeaderId",
                table: "FiscalTransmissions",
                column: "SaleHeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_FiscalTransmissions_Status",
                table: "FiscalTransmissions",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Terminals_BranchId_Code",
                table: "Terminals",
