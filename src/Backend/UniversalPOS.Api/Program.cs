...
{
    // Without this, the handler remaps short claim types like "sub" to legacy
    // ClaimTypes.* URIs on validation, silently breaking any code (e.g.
    // CurrentUserService) that looks up the original JWT claim name.
